...
namespace Infrastructure.Migrations.CourseManagment
{
    ...
    partial class CourseManagmentContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entites.CourseManagment.Course", b =>
                {
                    ...
                    b.Property<string>("PreRequiredId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Entites.CourseManagment.Course", b =>
                {
                    b.HasOne("Domain.Entites.CourseManagment.PreRequired", "PreRequired")
                        .WithMany("PreRequiredCourses")
                        .HasForeignKey("PreRequiredId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PreRequired");
                });
            ...
            modelBuilder.Entity("Domain.Entites.CourseManagment.PreRequired", b =>
                {
                    b.Navigation("PreRequiredCourses");
                });
